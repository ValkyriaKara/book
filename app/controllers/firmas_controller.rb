class FirmasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @firma.save
        format.html { redirect_to firma_url(@firma), notice: "Firma ha sido creada." }
  ...
  def update
    respond_to do |format|
      if @firma.update(firma_params)
        format.html { redirect_to firma_url(@firma), notice: "Firma ha sido editada." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to firmas_url, notice: "Firma ha sido eliminada." }
  ...
  private
    ...
    def firma_params
      params.require(:firma).permit(:nombre, :saludo)
    end
end
